...
async function init() {
  ...
  if (count.c === 0) {
    ...
    await ins(['MZ. A, LOTE 1 LOTIZACION LA CAMPIÑA', 'Predio - Calle La Campiña, Yurimaguas', 'terreno', 'venta', 30000, 'PEN', 'Av. Larco 450', 'Miraflores', 0, 0, null, 0, null, 1, -12.1211, -77.0282]);
